export default function BottomNavigation() {
  return (
    <nav className="w-full  xs:w-[390px] xs:overflow-x-hidden bottom-0 transform -translate-x-1/2 left-1/2 flex items-center justify-between bottom fixed z-10 h-[84px] pl-[35px] pr-[24px] bg-sub2">
      <div className="gap-[4px] text-[#F2F2F2] text-tooltip flex flex-col items-center">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
      ...
      <div className="gap-[4px] flex text-[#F2F2F2] text-tooltip flex-col items-center">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
